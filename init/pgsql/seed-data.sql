...
('birth', 'subject', 'child', 'child', true, false, false, null),
('birth', 'mother', 'mother', 'child', false, true, false, null),
('birth', 'father', 'father', 'child', false, true, false, null),

-- Marriage event mappings  
('marriage', 'bride', 'spouse', 'spouse', false, true, false, 'spouses'),
('marriage', 'groom', 'spouse', 'spouse', false, true, false, 'spouses'),
